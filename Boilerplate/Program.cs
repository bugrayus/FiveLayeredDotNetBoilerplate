        ...
        public static void Main(string[] args)
        {
            Log.Logger = new LoggerConfiguration()
                ...
                .Override("Microsoft.AspNetCore",
                    LogEventLevel.Warning) // Don't change this without asking the PROJECT MANAGER!
                .Enrich.FromLogContext()
                .WriteTo
                .Console(
                    new RenderedCompactJsonFormatter()) // inside console: outputTemplate: "[{Timestamp:HH:mm:ss} {Level:u3}] {Message:lj} {Properties:j}{NewLine}{Exception}")
